...
@section('content')
<div class="container mx-auto" style="margin: 37px;">
     <!-- Header Section -->
    <div class="mb-6">
    ...
    <div  style="display: flex;" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-items-center">
        @if($recipes->isEmpty())

            ...
            <div class="flex items-center space-x-4">
                <button 
                    ...
                    <div class="p-1 rounded-full group-hover:bg-red-50 transition-colors">
                        <svg class="w-8 h-8 heart-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="text-sm like-text">{{ $recipe->reaction_count }}</span>
                </button>
                <script>
                            ...
                            const text = button.querySelector('.like-text');
                                try {
                                    ...
                                    if (data.status === 'liked') {
                                        ...
                                        text.textContent = data.reaction_count.toString();
                                    } else {

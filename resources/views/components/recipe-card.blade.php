<div class="relative bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 h-245 w-200 flex flex-col">
    <a href="{{ route('recipeDetails', $recipe) }}" class="absolute inset-0 z-10"></a>
    ...
    <!-- Information section (always at the bottom) -->
    <div class="relative mt-auto bg-white/90 backdrop-blur-sm p-4 flex flex-col space-y-3">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="flex-1">
                <h3 class="font-semibold text-gray-900">{{ $recipe->user->name ?? 'Unknown Chef' }}</h3>
        ...
        <p class="text-gray-700 leading-relaxed text-sm">{{ Str::limit($recipe->body, 120) }}</p>

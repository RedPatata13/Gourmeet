...
<div class="w-200 flex flex-col">
    ...
    <div class="p-6 overflow-y-auto flex-grow">
        ...
        <div class="mb-8 w-full">
            ...
            <button wire:click="updatePersonalInfo" class="mt-6 px-4 py-2 text-sm font-medium text-white bg-[#111827] rounded-md hover:bg-gray-800 transition duration-150">
                Save Personal Info
            </button>
        </div>
        ...
        <div class="mb-8">
            ...
            <button wire:click="updateEmail" class="mt-4 px-4 py-2 text-sm font-medium text-white bg-[#111827] rounded-md hover:bg-gray-800 transition duration-150">
                Update Email
            </button>
        </div>
        ...
        <div class="mb-4">
            ...
            <button wire:click="updatePassword" class="mt-6 px-4 py-2 text-sm font-medium text-white bg-[#111827] rounded-md hover:bg-gray-800 transition duration-150">
                Update Password
            </button>
        </div>
